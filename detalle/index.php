...
<body>
    <div class="container-fluid">
        <form method="POST" action="<?= ACTI.$action; ?>" enctype="multipart/form-data" class="card row">
            <div class="card-head">
                <h5 class="card-title" id="agregarUsuarioModalLabel">Editar Usuario</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombres" name="nombres" value="<?= $call->nombres; ?>" />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="apellidos">Apellidos</label>
                            <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?= $call->apellidos; ?>" />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="usuario">Usuario</label>
                            <input type="text" class="form-control" id="usuario" name="usuario" value="<?= $call->usuario; ?>" />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="correo">Correo</label>
                            <input type="email" class="form-control" id="correo" name="correo" value="<?= $call->correo; ?>" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
